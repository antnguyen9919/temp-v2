        ...
        <Grid container spacing={7}>
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              type='email'
              label='Email'
              placeholder={!loading && user && user.email ? user.email : 'johnDoe@example.com'}
              defaultValue={!loading && user && user.email ? user.email : 'johnDoe@example.com'}
            />
          </Grid>
          <Grid item xs={12} sm={6}>
